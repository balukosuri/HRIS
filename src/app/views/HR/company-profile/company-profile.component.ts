...
stateId:any;
  ...
  companyProfileForm = this.fb.group({
    ...
    company_registered_address2:['', [ Validators.pattern('^[a-zA-Z0-9, ]*$')]], 
    company_registered_address3:['', [ Validators.pattern('^[a-zA-Z0-9, ]*$')]],   
    city:['', [Validators.required]],
    state: ['', [Validators.required]],   
    pincode:['',[Validators.required,Validators.pattern('[0-9]{6}')]],
    country:['', [Validators.required]],
    gst_no:['',Validators.pattern('^[a-zA-Z0-9, ]*$')],
    website:[''], 
    ...
    tan:['', [Validators.required, Validators.pattern('^[a-zA-Z0-9, ]*$')]],
